package locators.Anatomy;

public class AnatomyLoactors {
    public String Title_Module_anatomy = ":id/title_anatomy";
    ...
    public String IdClosePicture = ":id/close_full_image";
    public String IdTitlePicture =  ":id/txt_title_full_image']";
   public String elementId1 = "(//android.view.ViewGroup[@resource-id=\"com.mobelite.emeeApp:id/constraint_layout_content\"])[1]";
